...
class TabsClass {
  ...
  constructor(selector, options) {
    ...
    this.tabsEl = typeof selector === 'string' ? document.querySelector(selector) : selector;
    ...
    this.tabsBodyList = this.tabsEl.querySelector(`.${this.classes.tabsBodyList}`);
    this.tabsBodyItem = this.tabsEl.querySelectorAll(`.${this.classes.tabsBodyItem}`);
  ...
  #init() {
    ...
    this.tabsBodyList.addEventListener('transitionend', this.transitionEndHandler);
  }
  ...
  destroy() {
    ...
    this.tabsBodyList.removeEventListener('transitionend', this.transitionEndHandler);
  }
...
// =============================================================================================================================
;// ./src/js/components/tabs-services.js

const tabsServices = new TabsClass('.tabs-services');
;// ./src/js/components/about.js
function transitionEvent(selectorBox, selectorItems) {
  let delay = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1.5;
  let duration = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.5;
...
transitionEvent('.about__progress-center-wrapper', '.about__progress-number', 1, 0.5);
transitionEvent('.about__progress-bottom-wrapper', '.about__progress-bottom-text', 1, 0.5);
;// ./src/js/libs/modal.js
class Modal {
  defaultOptions = {};
  constructor(params) {
    this.params = Object.assign(this.defaultOptions, params);
    this.modalEl = typeof params.selectorModal === 'string' ? document.querySelector(params.selectorModal) : params.selectorModal;
    this.btnOpenList = typeof params.selectorButton === 'string' ? document.querySelectorAll(params.selectorButton) : [params.selectorButton];
    // Если нет элемента на странице, дальше код не выполняется
...
//   mediaQueryList.addEventListener('change', handleMediaQuery);
// })();
;// ./src/js/components/modal-gallery.js

const thumbnailGalleryItem = document.querySelectorAll('.thumbnail-gallery__item');
...
;// ./src/js/components/tabs-price-list.js

const tabs = new TabsClass('.price-list-tabs');
;// ./src/js/components/price-list-slider.js
